...
//  functions set-1
    ...
    function openEmbedDialog() {
        ...
        $("#embed-dialog").html('<div style="text-align:center;margin-top:20px;margin-bottom:20px"><textarea style="margin:auto;width:90%;height:90px"><iframe frameborder="0" height="1650px" src="http://www-ig-opensocial.googleusercontent.com/gadgets/ifr?exp_rpc_js=1&exp_track_js=1&url=http%3A%2F%2Fcws-mg.googlecode.com%2Fsvn%2Ftrunk%2Fsp%2Fig%2Fbys%2Fsp-bys-ig.xml&container=ig&view=canvas&lang='+language+'&country='+country+'&sanitize=0&v=87af6f13a0f771d3&gadgetId=106076965437172832281" width="100%"></iframe></textarea></div>');
...
//  innertabs makeRequest()
 ...
 //	Innertabs01
    ...
    function Innertabs011(){
        ...
        var params = {};
        params[gadgets.io.RequestParameters.CONTENT_TYPE] = gadgets.io.ContentType.JSON;
        var MY_URL = "http://publishers.spilgames.com/rss?cat=0&lang="+ langCountry +"&tsize=2&format=json";
